...
发布包：[`@liushutan/dsh-skills-manager@0.1.30`](https://www.npmjs.com/package/@liushutan/dsh-skills-manager/v/0.1.30)。

## 0.1.29 — 2026-08-28

- 恢复 DSH 系列 README 的标准头部导航：更新日志入口位于语言切换与 Apache-2.0 许可证链接之间。

发布包：[`@liushutan/dsh-skills-manager@0.1.29`](https://www.npmjs.com/package/@liushutan/dsh-skills-manager/v/0.1.29)。

## 0.1.28 — 2026-08-28

- 将 README 中的更新日志入口前移到页面顶部，打开项目即可看到发布历史。

发布包：[`@liushutan/dsh-skills-manager@0.1.28`](https://www.npmjs.com/package/@liushutan/dsh-skills-manager/v/0.1.28)。
...
发布包：[`@liushutan/dsh-skills-manager@0.1.27`](https://www.npmjs.com/package/@liushutan/dsh-skills-manager/v/0.1.27)。
...
发布包：[`@liushutan/dsh-skills-manager@0.1.26`](https://www.npmjs.com/package/@liushutan/dsh-skills-manager/v/0.1.26)。
